...
<body>
  ...
  <main>
    ...
    <ul>
      ...
      <li><a href="latest_v64_investor_report.html">V6.4 정답지 검증 + 수익률 확대 요약</a> - 방어 전략이 사후 최적화인지 감사하고 공격형 후보를 비교</li>
      <li><a href="latest_v64_hindsight_audit_report.html">V6.4 정답지 사용 여부 감사</a> - 거래 전 정보만 사용했는지 검사</li>
      <li><a href="latest_v64_scenario_comparison_report.html">V6.4 시나리오 비교</a> - Baseline, Balanced, Aggressive, High-Octane 비교</li>
