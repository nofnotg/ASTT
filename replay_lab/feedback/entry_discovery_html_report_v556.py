...
class EntryDiscoveryHTMLReportV556:
    def build(self, sessions_dir: str | Path = REPLAY_STORE_DIR / "sessions" / "realistic_paper_v555") -> Path:
        ...
        (out / "entry_discovery_report.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2, default=str), encoding="utf-8")
        ...
        (docs_reports_dir / "latest_entry_discovery_summary.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2, default=str), encoding="utf-8")
